...
import com.example.photo.databinding.FragmentWallpaperBinding
...
class WallpaperFragment : Fragment() {
    ...
    private val viewModel: WallpaperViewModel by viewModels {
        WallpaperViewModel.factory(ServiceLocator.provideRepository(requireContext()))
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.retryButton.setOnClickListener { viewModel.loadWallpapers(forceRefresh = true) }
    ...
    private fun renderState(state: UiState<List<Photo>>) {
        ...
        binding.wallpaperList.isVisible = showList
        ...
        when (state) {
            ...
            UiState.Empty -> binding.stateMessage.text = getString(R.string.wallpapers_state_empty)
            UiState.Loading -> binding.stateMessage.text = getString(R.string.wallpapers_loading)
        }
    }
    ...
    private fun openDetail(photo: Photo) {
        ...
        findNavController().navigate(R.id.action_wallpaperFragment_to_photoDetailFragment, args)
    }
