package com.example.photo.ui.discover
...
import com.example.photo.databinding.FragmentDiscoverBinding
...
class DiscoverFragment : Fragment() {
    ...
    private val viewModel: DiscoverViewModel by viewModels {
        DiscoverViewModel.factory(ServiceLocator.provideRepository(requireContext()))
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.retryButton.setOnClickListener { viewModel.loadDiscoverPhotos(forceRefresh = true) }
    ...
    private fun renderState(state: UiState<List<Photo>>) {
        ...
        binding.discoverList.isVisible = showList
        ...
        when (state) {
            ...
            UiState.Empty -> binding.stateMessage.text = getString(R.string.discover_state_empty)
            UiState.Loading -> binding.stateMessage.text = getString(R.string.discover_loading)
        }
    }
    ...
    private fun openDetail(photo: Photo) {
        ...
        findNavController().navigate(R.id.action_discoverFragment_to_photoDetailFragment, args)
    }
